...
uses
	Windows, Classes, ActiveX, ComObj, MSHTML_TLB;  //beginner
...
type
    ...
    FOnMouseMove: TDocumentContextMenuEvent; //beginner
    FSrcElement: IHTMLElement; //beginner
	protected
		{ IUnknown }
    ...
    property OnMouseMove: TDocumentContextMenuEvent read FOnMouseMove write FOnMouseMove; //beginner
    property SrcElement: IHTMLElement read FsrcElement; //beginner
	end;
...
begin
  {beginner}
  try
    FsrcElement := IHTMLDocument2(FSimpleDisp).parentWindow.event.srcElement;
  except
  end;
  {/beginner}
	case DispID of
